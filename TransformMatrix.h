...
public:
    ...
    void Translate( GLfloat X, GLfloat Y, GLfloat Z )             { Matrices_.top() = glm::translate( Matrices_.top(), glm::vec3(X, Y, Z) ); }
    void Rotate( GLfloat Angle, GLfloat X, GLfloat Y, GLfloat Z ) { Matrices_.top() = glm::rotate( Matrices_.top(), (GLfloat)glm::radians(Angle), glm::vec3(X, Y, Z) ); }

    void LookAt( GLfloat ObsX, GLfloat ObsY, GLfloat ObsZ, GLfloat TargetX, GLfloat TargetY, GLfloat TargetZ, GLfloat UpX, GLfloat UpY, GLfloat UpZ )
    {
        Matrices_.top() = glm::lookAt( glm::vec3( ObsX, ObsY, ObsZ ), glm::vec3( TargetX, TargetY, TargetZ ), glm::vec3( UpX, UpY, UpZ ) );
    }
